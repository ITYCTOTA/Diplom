...
import { useGameHubRoute } from '@/app/router'
import { useGameHubState } from '@/app/model/useGameHubState'
...
const RecommendationsPage = lazy(() =>
  import('@/pages/recommendations').then((module) => ({ default: module.RecommendationsPage })),
)
...
const PurchaseModal = lazy(() =>
  import('@/features/purchase-game').then((module) => ({ default: module.PurchaseModal })),
)
const FriendSearchModal = lazy(() =>
  import('@/features/find-friend').then((module) => ({ default: module.FriendSearchModal })),
)
const CreateGroupModal = lazy(() =>
  import('@/features/create-group').then((module) => ({ default: module.CreateGroupModal })),
)
...
function App() {
  ...
  const isPurchaseOpen = Boolean(purchaseGame && purchaseView === activeView)
      ...
      case 'game':
        ...
        return (
          <GamePage
            ...
            onOpen={openGame}
            onRatingChange={updateGameRating}
          />
        )
      case 'library':
        return (
  ...
  return (
    ...
    >
      ...
      {isPurchaseOpen && purchaseGame && (
        <Suspense fallback={null}>
          <PurchaseModal
            game={purchaseGame}
            isPending={isPurchasePending}
            onCancel={() => { setPurchaseGame(null); setPurchaseView(null) }}
      ...
      {isFriendSearchOpen && authUser && (
        <Suspense fallback={null}>
          <FriendSearchModal
            ...
            onClose={() => setFriendSearchView(null)}
      ...
      {isCreateGroupOpen && authUser && (
        <Suspense fallback={null}>
          <CreateGroupModal
            onClose={() => setCreateGroupView(null)}
