import type { Friend, FriendRequest, FriendSearchResult } from '@/entities/friendship'
import type { Game } from '@/entities/game'
import type { Group, GroupMember, GroupPost } from '@/entities/group'
import type { Review } from '@/entities/review'
import type { AuthUser, UserPost, UserProfile } from '@/entities/user'
...
export async function createGameReview(gameId: string, rating: number, text: string) {
  const response = await apiRequest<{ review: Review }>(`/games/${gameId}/reviews`, {
    method: 'POST',
